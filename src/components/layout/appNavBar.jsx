          ...
          <div className="collapse navbar-collapse d-lg-flex justify-content-between flex-row-reverse" id="nav06">
            <div className="d-flex align-items-center">
              <div className="input-group border rounded-2">
                <input
                  ...
                  aria-label="Search"
                />
                <Link to={search.length > 0 ? `/products?search=${search}` : `/`} className="btn search" type="submit">
                  <svg
              ...
              {isLogin() ? (
                <>
                  ...
                  <div className=" position-relative mx-3">
                    ...
                    {visible ? (
                      <div className="pop-up position-absolute end-0 top-100 mt-1 border py-3 px-4 bg-white rounded">
            ...
            <ul className="navbar-nav mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
              <span className="nav-item me-4">
                <Link className="nav-link" to={`/remark/${'new'}`}>
                  New Arrival
                </Link>
              </span>
              <span className="nav-item me-4">
              ...
              <span className="nav-item me-4">
                <Link className="nav-link" to={`/remark/${'trending'}`}>
                  Trending
                </Link>
              </span>
            </ul>
