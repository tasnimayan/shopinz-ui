      ...
      <form className="mb-9">
        <div className="d-flex flex-wrap justify-content-between mb-5">
          ...
          <div className="d-flex align-items-end gap-2">
            <button type="button" className="btn btn-gray fs-sm fw-semibold" onClick={discard}>
              Discard
            </button>
            <button type="button" className="btn btn-gray fs-sm fw-semibold" onClick={saveDraft}>
              Save draft
            </button>
            <button type="submit" onClick={publishProduct} className="btn py-2 btn-primary fs-sm fw-semibold">
              Publish product
            </button>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-8 col-12">
            ...
            <input
              ...
              onChange={(e) => {
                productDataOnChange('title', e.target.value);
              }}
            />
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={(e) => {
                  productDataOnChange('des', e.target.value);
                }}
              ></textarea>
            </div>
            <div className="mb-5">
              ...
              >
                <div className="position-relative fw-bold d-flex flex-column align-items-center">
            ...
            <div>
              ...
              <div className="row g-0 border-top border-bottom">
                ...
                <div className="col-sm-4 col-12 bg-white">
                  <ul
                    className="nav nav-tabs flex-sm-column border-bottom border-bottom-sm-0 border-end-sm h-100 justify-content-between"
                    id="myTab"
                    role="tablist"
                  >
                    <li className="nav-item" role="presentation">
                      <a
                        ...
                        aria-selected="true"
                        className="nav-link active text-sm-start cursor-pointer outline-none d-sm-flex align-items-sm-center border-bottom-sm border-end border-end-sm-0"
                        href="#pricing"
                      >
                    ...
                    <li className="nav-item" role="presentation">
                      <a
                        className="nav-link text-center text-sm-start cursor-pointer outline-none d-sm-flex align-items-sm-center border-bottom-sm border-end border-end-sm-0"
                        id="restock-tab"
                        data-bs-toggle="tab"
                  ...
                  <div className="py-3 ps-sm-4 h-100 tab-content">
                    <div className="tab-content" id="myTabContent">
                        ...
                        <div className="g-3 row">
                          <div className="col-lg-6 col-12">
                            ...
                            <input
                              ...
                              className="form-control"
                              onChange={(e) => {
                                productDataOnChange('price', e.target.value);
                              }}
                            />
                          </div>
                          <div className="col-lg-6 col-12">
                            ...
                            <input
                              ...
                              className="form-control"
                              onChange={(e) => {
                                productDataOnChange('discountPrice', e.target.value);
                              }}
                            />
                          </div>
                        </div>
                          ...
                          <div className="flex-1 mb-4">
                            <div className="d-flex gap-3">
                              <input
                                ...
                                onChange={(e) => {
                                  productDataOnChange('stock', e.target.value);
                                }}
                              />
                          ...
                          <div className="flex-1">
                            <div className="mb-4">
                              <div className="form-check">
                                ...
                                />
                                <label htmlFor="fullfilledBySeller" className="text-900 fs-8 form-check-label">
                            ...
                            <div className="mb-4">
                              <div className="form-check">
                                <input
                                  ...
                                  className="form-check-input"
                                />
                                <label htmlFor="fullfilledByPhoenix" className="text-900 fs-8 form-check-label">
                                  Fullfilled by ShopinZ
                                  <span className="ms-2 badge-phoenix badge-phoenix-warning badge">Recommended</span>
                                </label>
                              </div>
                              <div className="ps-4">
                                <p className="text-800 fs-9 mb-0">
                      ...
                      <div className="tab-pane fade" id="attributes" role="tabpanel" aria-labelledby="attributes-tab">
                        ...
                        <div className="form-check">
                          <input name="attributes" type="checkbox" id="fragileCheck" className="form-check-input" />
                          <label htmlFor="fragileCheck" className="text-900 fs-8 form-check-label">
                            Fragile Product
                          </label>
                        </div>
                        <div className="form-check">
                          <input
                            ...
                            className="form-check-input"
                          />
                          <label htmlFor="biodegradableCheck" className="text-900 fs-8 form-check-label">
                            Biodegradable
                          </label>
                        </div>
                        <div className="mb-3 form-check">
                          <input name="attributes" type="checkbox" id="frozenProduct" className="form-check-input" />
                          <label htmlFor="frozenProduct" className="text-900 fs-8 form-check-label">
                            Frozen Product
                          </label>
                          <input
                        ...
                        <div className="form-check">
                          <input name="attributes" type="checkbox" id="expDate" className="form-check-input" />
                          <label htmlFor="expDate" className="text-900 fs-8 form-check-label">
                            Expiry Date of Product
                          </label>
                          <input type="date" id="expDate" className="form-control" style={{ maxWidth: '350px' }} />
                        </div>
                      </div>
                        ...
                        <div className="row g-3">
                          <div className="col-12">
                            <h6 className="mb-2 text-1000">
                              SKU <span className="fs-sm">(Stock Keeping Unit)</span>
                            </h6>
                            <input
                              placeholder="SKU ID"
                              type="text"
                              className="form-control"
                              onChange={(e) => {
                                productDataOnChange('sku', e.target.value);
                              }}
                            />
                          </div>
                        </div>
          ...
          <div className="col-lg-4 col-12">
            <div className="mb-3 card border">
              <div className="card-body">
                ...
                <select
                  aria-label="category"
                  className="form-select overflow-y-scroll"
                  onChange={(e) => {
                    productDataOnChange('categoryID', e.target.value);
                  }}
                >
                ...
                <div className="col-xl-12 col-sm-6 col-12">
                  ...
                  <select
                    ...
                    className="form-select overflow-y-scroll"
                    onChange={(e) => {
                      productDataOnChange('brandID', e.target.value);
                    }}
                  >
                    <option value="" selected disabled>
                      -----
                ...
                <div className="col-xl-12 col-sm-6 col-12">
                  ...
                  <input
                    ...
                    className="form-control"
                    onChange={(e) => {
                      productDataOnChange('tags', e.target.value);
                    }}
                  />
                </div>
            ...
            <div className="card border">
              <div className="card-body">
                  ...
                  <div className="col-xl-12 col-sm-6 col-12">
                    <div className="border-bottom border-dashed border-sm-0 border-bottom-xl pb-4">
                      <div className="d-flex gap-2 mb-2">
                        ...
                        <a className="fw-bold fs-9" href="/apps/e-commerce/admin/add-product#!">
                          Remove
                        </a>
                      </div>
                      ...
                      <div className="react-select-container">
                        <div className=" css-b62m3t-container">
                          <span id="react-select-6-live-region"></span>
                ...
                <button type="button" className="w-100 btn btn-gray text-link fs-sm fw-semibold">
                  Add another option
                </button>
              </div>
            </div>
