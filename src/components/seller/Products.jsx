        ...
        <div className="my-5 ">
          ...
          <div className="mb-2 nav nav-links nav">
            <div className="nav-item">
              <a role="button" className="px-2 active nav-link" tabIndex="0" href="/seller/products">
                All <span className="text-700 fw-semi-bold">({SellerProducts.length})</span>
              </a>
            </div>
            <div className="nav-item">
              <a role="button" className="px-2 nav-link" tabIndex="0" href="/seller/products">
                Published <span className="text-700 fw-semi-bold">({SellerProducts.length})</span>
              </a>
            </div>
            <div className="nav-item">
              <a role="button" className="px-2 nav-link" tabIndex="0" href="/seller/products">
                Drafts <span className="text-700 fw-semi-bold">(0)</span>
              </a>
            </div>
            <div className="nav-item">
              <a role="button" className="px-2 nav-link" tabIndex="0" href="/seller/products">
                On discount <span className="text-700 fw-semi-bold">({SellerProducts.length})</span>
              </a>
            </div>
          </div>
              ...
              <div className="search-box">
                <form className="input-group border rounded-2 p-0" onSubmit={onSearch}>
                  <input
                    ...
                    className="form-control border-0 searchbox shadow-none"
                    type="search"
                    value={search}
                    placeholder="Search products"
                    aria-label="Search"
                  />
                  <button className="bi bi-search fs-lg btn search" type="submit" onClick={onSearch}>
                    <i className="bi bi-search fs-lg btn search"></i>
                  </button>
                </form>
              </div>
              ...
              <div className="scrollbar overflow-hidden-y">
                <div role="group" className="position-static btn-group">
                  <div role="group" className="position-static dropdown btn-group">
                    <button
                      type="button"
                      id="react-aria9106521202-:r6:"
                      aria-expanded="false"
                      className="px-7 flex-shrink-0 dropdown-caret-none dropdown-toggle btn btn-phoenix-secondary"
                ...
                <table className="phoenix-table fs-9 table">
                  <thead>
                    <tr>
                      ...
                      <th className="ps-4 sort" style={{ width: '350px' }}>
                        Product name
                      </th>
                      <th className="ps-4 text-end sort" style={{ width: '150px' }}>
                        Price
                      </th>
                      <th className="ps-4 sort" style={{ width: '150px' }}>
                        Category
                      </th>
                      <th className="ps-3" style={{ width: '225px', minWidth: '200px' }}>
                        Tags
                      </th>
                      <th className="ps-3" style={{ width: '50px' }}>
                        Stock
                      </th>
                      <th className="ps-4 sort" style={{ width: '50px' }}>
                        Published on
                      </th>
              ...
              <div className="align-items-center py-1 row">
                <div className="d-flex col">
                  <p className="mb-0 d-none d-sm-block me-3 fw-semi-bold text-900">
                    1 to 10<span className="text-600"> items of </span>16
                  </p>
                ...
                <div className="col-auto">
                  <ul className="mb-0 justify-content-center pagination">
                    ...
                    <li className="page-item">
                      <a className="page-link" role="button" tabIndex="0" href="/seller/products">
                        2
                      </a>
                    </li>
                    <li className="page-item">
