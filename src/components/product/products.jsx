            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12">
                        <div>
                            <div className="mb-4 d-inline-block w-100 border-bottom text-center text-md-start">
                                <span className='btn bg-dark text-white rounded-0 headline-4 p-0 mb-sm-4 mb-md-0'>Our Products</span>
                            
                                <ul className="nav nav-tabs justify-content-center border-0 font-raleway fs-6 float-end" id="pills-tab" role="tablist">
