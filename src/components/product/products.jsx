                                                ...
                                                <div className="row">
                                                    {
                                                        ListByRemark.map((item,i)=>{
                                                            ...
                                                            if(item['discount']===true){
                                                                price=<p className="bodyMedium text-dark my-1">Price:<strike className="text-danger"> ${item['price']} < /strike> <span className='text-success fw-semibold'>${item['discountPrice']}</span> </p>
                                                            }
                                                            return(
                                                                <div className="border col-md-3 p-2 col-lg-3 col-sm-6 col-12">
